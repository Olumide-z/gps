      ...
      <div className='w-full h-[580px] relative'>
        ...
        <div className='flex items-center gap-2 absolute bottom-[.7rem] w-[96%] h-[95px] p-[1rem] left-[.5rem] right-2'>
          ...
          <div className='w-[75%] h-full rounded-sm font-[500] font-sans rounded-tr-[0px] leading-[15px] padding text-white bg-[rgba(0,0,0,0.55)] backdrop-filter'>
            <div style={{ paddingTop: '2px'}} className='flex items-center gap-1 absolute right-[0] top-[-1.85rem] font-[900] m-3 bg-[rgba(0,0,0,0.55)] backdrop-filter'>
              <Image 
                src='/images/gps.jpg' 
                alt='s' 
                height={15} 
            ...
            <p className='text-[0.65rem]'>{data.location}</p>
